...
<link href="${contextPath }/assets/reference_board/css/reference_board_write.css" rel="stylesheet" />
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			...
			<div id="page-inner">
				...
				<script
					src="${contextPath}/assets/materialize/js/materialize.min.js"></script>
				<!-- Metis Menu Js -->
